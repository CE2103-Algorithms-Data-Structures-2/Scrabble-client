...
"  padding-left: 35px;"));
    ...
    {
        ConfigLobbyMenu->setWindowTitle(QApplication::translate("ConfigLobbyMenu", "Scrabble", 0));
        label_2->setText(QApplication::translate("ConfigLobbyMenu", "Nombre del lobby", 0));
        label->setText(QApplication::translate("ConfigLobbyMenu", "<html><head/><body><p><span style=\" font-size:36pt;\">Seleccione la configuraci\303\263n de su lobby</span></p></body></html>", 0));
        label_4->setText(QApplication::translate("ConfigLobbyMenu", "Cantidad de jugadores", 0));
        comboBox->clear();
        comboBox->insertItems(0, QStringList()
         << QApplication::translate("ConfigLobbyMenu", "2", 0)
         << QApplication::translate("ConfigLobbyMenu", "3", 0)
         << QApplication::translate("ConfigLobbyMenu", "4", 0)
        );
        label_3->setText(QApplication::translate("ConfigLobbyMenu", "Su nombre", 0));
        pushButton->setText(QApplication::translate("ConfigLobbyMenu", "Enviar", 0));
    } // retranslateUi
