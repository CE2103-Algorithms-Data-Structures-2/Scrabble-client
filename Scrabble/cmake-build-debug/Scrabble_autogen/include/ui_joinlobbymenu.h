...
""));
    ...
    {
        JoinLobbyMenu->setWindowTitle(QApplication::translate("JoinLobbyMenu", "WizardPage", Q_NULLPTR));
        label->setText(QApplication::translate("JoinLobbyMenu", "Ingrese el c\303\263digo del lobby al que desea unirse", Q_NULLPTR));
    } // retranslateUi
