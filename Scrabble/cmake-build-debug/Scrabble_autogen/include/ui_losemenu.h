...
""));
    ...
    {
        LoseMenu->setWindowTitle(QApplication::translate("LoseMenu", "WizardPage", Q_NULLPTR));
        label->setText(QApplication::translate("LoseMenu", "\302\241Has Perdido!", Q_NULLPTR));
        pushButton->setText(QApplication::translate("LoseMenu", "Volver al menu principal", Q_NULLPTR));
    } // retranslateUi
