...
""));
    ...
    {
        WinMenu->setWindowTitle(QApplication::translate("WinMenu", "WizardPage", 0));
        label->setText(QApplication::translate("WinMenu", "\302\241Has Ganado!", 0));
        pushButton->setText(QApplication::translate("WinMenu", "Volver al menu principal", 0));
    } // retranslateUi
